...
// broadcastMsg is sent to every WebSocket client connected to the embedded
// backend. It is used for local synthetic events, such as echoing a comment
// that AcFun accepts but may not push back to the sender.
